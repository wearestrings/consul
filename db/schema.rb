...
ActiveRecord::Schema.define(version: 20170920201750) do
  ...
  create_table "poll_shifts", force: :cascade do |t|
    ...
    t.boolean  "collect_vote",     default: false, null: false
    t.boolean  "recount_scrutiny", default: false, null: false
  end
